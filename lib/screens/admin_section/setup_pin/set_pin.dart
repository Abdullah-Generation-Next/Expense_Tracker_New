...
class AdminSetPin extends StatefulWidget {
  ...
  @override
  State<AdminSetPin> createState() => _AdminSetPinState();
}

class _AdminSetPinState extends State<AdminSetPin> {
  var selectedIndex = 0;
  String code = '';
  ...
  //   inheritedWidget = context.dependOnInheritedWidgetOfExactType<InheritedWidget>();
  // }
  //
  // @override
  // void dispose() {
  //   // Use the inheritedWidget reference safely here
  //   inheritedWidget?.doSomething();
  //   super.dispose();
  // }
  ...
  //     isProcessing = true;
  //   });
  //   DocumentSnapshot userSnapshot = await FirebaseFirestore.instance.collection('Admin').doc(widget.adminId).get();
  //
  //   setState(() {
  ...
  /*void turnOffPin(BuildContext context) async {
    ...
    try {
      await FirebaseFirestore.instance.collection('Admin').doc(widget.adminId).update({'pin': '', 'isSwitchOn': false});
