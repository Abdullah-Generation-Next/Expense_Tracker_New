...
class AdminConfirmPin extends StatefulWidget {
  ...
  const AdminConfirmPin({
    Key? key,
    this.code,
    this.adminId,
    this.userId,
    this.userDoc,
    this.isFromSetPin = false,
  }) : super(key: key);

  @override
  State<AdminConfirmPin> createState() => _AdminConfirmPinState();
}

class _AdminConfirmPinState extends State<AdminConfirmPin> {
  var selectedIndex = 0;
  String code = '';
  String? storedCode;
        ...
        Future.delayed(Duration(milliseconds: 200), () {
          if (widget.userDoc?['isSwitchOn'] == true) {
            ...
            if (code == widget.code) {
              ...
              /*FirebaseFirestore.instance.collection('Admin').doc(widget.adminId).update({'pin': code}).then((_) {
