...
class AdminEditProfilePage extends StatefulWidget {
  ...
  const AdminEditProfilePage({super.key, required this.adminId});
...
class _AdminEditProfilePageState extends State<AdminEditProfilePage> {
  ...
  Future<void> _loadProfileData() async {
    try {
      if (kDebugMode) {
        print('Loading profile data for adminId: ${widget.adminId}');
      }
      DocumentSnapshot adminDoc = await FirebaseFirestore.instance.collection('Admin').doc(widget.adminId).get();
      ...
      if (adminDoc.exists) {
        ...
        if (data != null) {
          setState(() {
            ...
            controller.finalImageUrl.value = data['company_logo'] ?? '';
            isLoading = false;
          });
          if (kDebugMode) {
      ...
      try {
        ...
        if (controller.image.value != null) {
          ...
          if (compressedImage != null) {
            final storageRef =
                FirebaseStorage.instance.ref().child('Admin/$adminName/Logos/${DateTime.now().millisecondsSinceEpoch}');
        ...
        print('Updating profile for adminId: ${widget.adminId}');
        await FirebaseFirestore.instance.collection('Admin').doc(widget.adminId).update({
          'username': _userNameController.text,
          'email': _emailController.text,
          'phone': _phoneController.text,
          'company_name': _companyController.text,
          'company_address': _companyAddressController.text,
          'company_logo': controller.finalImageUrl.value,
        });
  ...
  Future<void> removeCompanyLogo(String adminId) async {
    setState(() {
      _isLoading1 = true;
    });
    try {
      ...
      await adminRef.update({'company_logo': ''});

      controller.finalImageUrl.value = '';
      controller.image.value = null;

      print("Company logo removed successfully.");
      Fluttertoast.showToast(msg: 'Company logo removed successfully.');
    } catch (e) {
      print("Error removing company logo: $e");
      Fluttertoast.showToast(msg: 'Error removing company logo.');
    } finally {
      setState(() {
        _isLoading1 = false;
      });
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              left: 70,
                              child: Tooltip(
                                message: 'Upload Company Logo/Image',
                    ...
                    TextFormField(
                      ...
                      onFieldSubmitted: (_) {
                        FocusScope.of(context).requestFocus(companyAddressFocusNode);
                      },
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.text,
                      style: const TextStyle(color: Colors.black),
                      decoration: _buildInputDecoration('Company Address', Icons.location_on),
                            ...
                            onPressed: _isLoading1 ? null : () {
                              ...
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  title: Text('Remove Company Logo'),
                                  content: Text('Are you sure you want to remove the company logo?'),
                                  actions: [
                                    TextButton(
                                    ...
                                    TextButton(
                                      onPressed: () async {
                                        await removeCompanyLogo(widget.adminId);
                                        Navigator.pop(context);
                                      },
                                      child: Text('Remove'),
                                    ),
